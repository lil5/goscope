...
<script src="https://unpkg.com/axios/dist/axios.min.js"></script>
	...
	return fmt.Sprintf(template, CommonHead, goscope_css.HighlightTheme(), goscope_css.WatcherStyles(), NavbarComponent("LOGS"), FooterText, goscope_js.JsUtils(), goscope_js.LogsJs())
}
